...
<Slider/>
 ...
 <section className="About-section">
  <div className="About-content">
    ...
    <div className='learn-more-arrow1'>
      <button>
        <a className='BsArrowUpRight' href="/about">Learn More <BsArrowUpRight className="group-hover:text-primarycolor w-6 h-5" /></a>
      </button>
    </div>
 ...
 <section className="service-section">
  ...
  <div className='learn-more-arrow1' style={{ display: "grid", placeContent: "center", }}>
    <button >
      <a className='BsArrowUpRight' style={{ display: "flex", fontWeight: "400" }} href="/services">Learn More <BsArrowUpRight className="group-hover:text-primarycolor w-6 h-5" /></a>
    </button>
  </div>
</section>
...
<div style={{backgroundImage: `url(${contactbg})`,}} className='contact-container' >
  ...
  <div className='container'>
    <div className='flex justify-center  gap-[150px] lg:gap-0'>
