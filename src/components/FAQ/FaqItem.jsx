...
const FaqItem = ({item}) => {
  ...
  return (
    <div className="p-3 lg:p-3 rounded-[20px] border border-solid border-[#D9DCE2] mb-5 cursor-pointer w-full bg-white ">
      <div className="flex items-center justify-between gap-5 " onClick={toggleAccordion}>
        <h4 className="text-[16px] leading-7 lg:text-[18px] lg:leading-8 text-textcolor font-semibold"> {item.question}</h4>
