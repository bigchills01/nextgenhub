...
const Slider = () => {
  ...
  return (
    <div  style={{backgroundImage: `url(${background})`,backgroundSize:"cover",backgroundRepeat:"no-repeat",backgroundPosition:"center", padding:"25px"}} className='slider '>
      <div className='ARROW'>
          ...
          <div  className={index === currentSlide ? "slide  current " :"slide"} key={index}>
            {index === currentSlide && (
              ...
              <div className='content '>
                ...
                <NavLink exact to='/services'><button className='btn'> Learn More </button>
                </NavLink>
                </div>
